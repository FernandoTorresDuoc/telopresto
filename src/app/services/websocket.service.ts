...
export class WebsocketService {
  ...
  confirmararriendo() {
    this.message = `confirmararriendo;${localStorage.getItem('userLogged')};${this.idServicio};${this.idArrendador};${this.numerodetransaccion}`
      ...
      buttons: [
        {
          ...
          handler: () => {
            this.AutenticacionService.crearTransaccion(this.AutenticacionService.marker.precio, this.idServicio,
              localStorage.getItem('userLogged')).subscribe(data => {
                console.log(data);
